...
/atom/movable/screen/meter_component/delta
	...
	animate_time = 0.5 SECONDS

	var/windup_time = 1.5 SECONDS	//When the user takes damage for the first time in a while, the delta willpause to show the extend of it before it starts animating down
...
/atom/movable/screen/meter_component/delta/New(var/atom/movable/screen/meternewparent)
	...
	animate_time = (1 SECONDS / ticks_per_second)
