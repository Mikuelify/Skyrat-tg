...
/datum/biomass_source/New(var/datum/_source = null, var/datum/_target = null, var/total_mass = 0, var/duration = 1 SECONDS)
	.=..()
	source = "\ref[_source]"
...
/datum/biomass_source/harvest/New(var/datum/_source = null, var/datum/_target = null, var/total_mass = 0, var/duration = 1 SECONDS)
	harvester = _source
	.=..()
