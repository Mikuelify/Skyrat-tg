/obj/structure/marker/special/growth
	name = "propagator"
	desc = "Corruption spreads out in all directions from this horrible mass."
	max_integrity = 200	//Takes a while to kill
	resistance = 8
	icon_state = "growth"
	density = FALSE
...
/obj/structure/marker/special/growth/debug
...
/obj/structure/marker/special/growth/debug/smol
	range = 2


/obj/structure/marker/special/growth/Initialize()
	.=..()
...
/obj/structure/marker/special/growth/get_blurb()
...
/obj/structure/marker/special/growth/get_visualnet_tiles(var/datum/visualnet/network)
...
/obj/structure/marker/special/growth/Destroy()
...
*/
/obj/structure/marker/special/growth/branch
	name = "branch"
	desc = "This is just a tribute"
	max_integrity = 45 // 60 -> 45, 17th of Jan, 2021.
	resistance = 6
...
/obj/structure/marker/special/growth/branch/get_blurb()
...
/datum/signal_ability/placement/corruption/branch
	...
	desc = ""
	energy_cost = 135
	placement_atom = /obj/structure/marker/special/growth/branch


/*
	Root: An alternate version for tight spaces
*/
/obj/structure/marker/special/growth/root
	name = "root"
...
/obj/structure/marker/special/growth/root/get_blurb()
...
/datum/signal_ability/placement/corruption/root
	...
	desc = ""
	energy_cost = 150
	placement_atom = /obj/structure/marker/special/growth/root
