...
*/
/obj/machinery/necromorph/marker
	name = "Marker"
...
/obj/machinery/necromorph/marker/New(var/atom/location, var/direction, var/nocircuit = FALSE)
...
/obj/machinery/necromorph/marker/proc/make_active()
	if (active)
		return
	active = TRUE
...
//	set_traumatic_sight(TRUE, 5) //Marker is pretty hard to look at.
	...
	var/datum/game_mode/necromorph/marker/GM = SSticker.mode
	if (GM && !GM.marker_active)
		GM.activate_marker()

/obj/machinery/necromorph/marker/Initialize()
	.=..()
...
//	GLOB.necrovision.add_source(src)	//Add it as the first source for necrovision
	...
	// var/datum/proximity_trigger/view/PT = new (holder = src, on_turf_entered = /obj/machinery/necromorph/marker/proc/nearby_movement, range = 10)
	// PT.register_turfs()
...
/obj/machinery/necromorph/marker/proc/open_shop(var/mob/user)
//	shop.ui_interact(user)

/*

/obj/machinery/necromorph/marker/attack_hand(var/mob/user)//Temporary
	open_shop(user)

/obj/machinery/necromorph/marker/attack_ghost(var/mob/user)//Temporary
	open_shop(user)
*/

/obj/machinery/necromorph/marker/update_icon()
	.=..()
	if (player && active)
...
/obj/machinery/necromorph/marker/Process()
	handle_biomass_tick()
	throb()

/obj/machinery/necromorph/marker/is_necromorph()
	return TRUE

/obj/machinery/necromorph/marker/verb/shop_verb()
...
/obj/machinery/necromorph/marker/proc/throb()
	if (player && active)
		if(world.time - last_throb > 3 MINUTES && prob(30))
			last_throb = world.time
			playsound(src.loc, 'modular_skyrat/modules/necromorphs/sound/effects/markerthrob.ogg', 25, 0)
...
/obj/machinery/necromorph/marker/proc/handle_biomass_tick()
...
/obj/machinery/necromorph/marker/proc/add_biomass_source(var/datum/source = null, var/total_mass = 0, var/duration = 1 SECONDS, var/sourcetype = /datum/biomass_source)
...
/obj/machinery/necromorph/marker/proc/remove_biomass_source(var/datum/biomass_source/source = null)
...
/obj/machinery/necromorph/marker/proc/become_master_signal(var/mob/M)
	if(!active)
		return
	if (!M || !M.key)
		return
	// if (player != ckey(M.key))
	// 	message_necromorphs("[M.key] has taken charge of the marker.")
...
/obj/machinery/necromorph/marker/proc/vacate_master_signal()
	if (playermob)
...
/obj/machinery/necromorph/marker/get_available_biomass()
	return biomass


//A mob was detected nearby, can we absorb it?
/obj/machinery/necromorph/marker/proc/nearby_movement(var/atom/movable/AM, var/atom/old_loc)
...
/obj/machinery/necromorph/marker/proc/pay_biomass(var/purpose, var/amount, var/allow_negative = FALSE)
...
//Corruption Handling
/*
/obj/machinery/necromorph/marker/proc/start_corruption()
	set_extension(src, /datum/extension/corruption_source, 12)
*/

/obj/machinery/necromorph/marker/proc/get_total_biomass()
...
/obj/machinery/necromorph/marker/proc/update_unavailable_biomass()
...
/obj/machinery/necromorph/marker/get_biomass()
	return null


/obj/machinery/necromorph/marker/ex_act()
	return null	//We do not break

/obj/machinery/necromorph/marker/emp_act()
	return null	//We do not break

/obj/machinery/necromorph/marker/bullet_act()
	return null	//We do NOT break

// /obj/machinery/necromorph/marker/default_deconstruction_crowbar(var/mob/user, var/obj/item/weapon/tool/crowbar/C)
// 	return

// /obj/machinery/necromorph/marker/default_deconstruction_screwdriver(var/mob/user, var/obj/item/weapon/tool/screwdriver/S)
// 	return

// /obj/machinery/necromorph/marker/default_part_replacement(var/mob/user, var/obj/item/weapon/storage/part_replacer/R)
// 	return

///obj/machinery/necromorph/marker/dismantle()
	//return


/proc/marker_active()
	var/obj/machinery/necromorph/marker/M = get_marker()
	if (M && M.active)
		return TRUE
