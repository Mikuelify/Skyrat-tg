...
/obj/item/organ/external/head/ubermorph
	...
	var/eye_icon = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/ubermorph.dmi'
...
/obj/item/organ/external/head/simple/slasher_enhanced
	normal_eyes = FALSE
	glowing_eyes = TRUE
	eye_icon_location = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/slasher_enhanced.dmi'
