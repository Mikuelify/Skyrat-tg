...
/datum/species/necromorphs/proc/has_fine_manipulation(var/mob/living/carbon/human/H)
	return has_fine_manipulation

/datum/species/necromorphs/proc/toggle_stance(var/mob/living/carbon/human/H)
	if(!H.incapacitated())
...
/datum/species/necromorphs/proc/get_offset_overlay_image(var/spritesheet, var/mob_icon, var/mob_state, var/color, var/slot)
