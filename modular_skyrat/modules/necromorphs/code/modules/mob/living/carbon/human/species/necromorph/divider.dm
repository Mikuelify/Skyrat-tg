...
/datum/species/necromorph/divider
	...
	say_mod = "hisses"
	limbs_id = "divider"
	limbs_icon = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/divider.dmi'

//	icon_template = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/divider/fleshy.dmi'
	//eyes_icon = 'modular_skyrat/master_files/icons/mob/species/vox_eyes.dmi'
//	limbs_icon = 'modular_skyrat/modules/necromorphs/icons/mob/necromorph/divider/fleshy.dmi'
